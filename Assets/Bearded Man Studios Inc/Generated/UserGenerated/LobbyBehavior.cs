...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	[GeneratedRPCVariableNames("{\"types\":[[\"name\", \"team\"][\"name\", \"team\"]]")]
	public abstract partial class LobbyBehavior : NetworkBehavior
	{
		public const byte RPC_CREATE_PLAYER = 0 + 5;
		public const byte RPC_SWITCH_PLAYER = 1 + 5;
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject.RegisterRpc("CreatePlayer", CreatePlayer, typeof(string), typeof(int));
			networkObject.RegisterRpc("SwitchPlayer", SwitchPlayer, typeof(string), typeof(int));
		...
		/// int team
		/// </summary>
		public abstract void SwitchPlayer(RpcArgs args);
