...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public abstract partial class CTFGameStateBehavior : NetworkBehavior
	{
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject = (CTFGameStateNetworkObject)obj;
		...
		{
			Initialize(new CTFGameStateNetworkObject(networker, createCode: TempAttachCode, metadata: metadata));
		}
		...
		{
			return new CTFGameStateNetworkObject(networker, this, createCode, metadata);
		}
