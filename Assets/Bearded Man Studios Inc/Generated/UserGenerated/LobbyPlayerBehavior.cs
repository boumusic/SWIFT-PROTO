...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	[GeneratedRPCVariableNames("{\"types\":[[\"teamIndex\"][\"name\"]]")]
	public abstract partial class LobbyPlayerBehavior : NetworkBehavior
	{
		public const byte RPC_CHANGE_TEAM = 0 + 5;
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject.RegisterRpc("ChangeTeam", ChangeTeam, typeof(int));
		...
		/// int teamIndex
		/// </summary>
		public abstract void ChangeTeam(RpcArgs args);
		/// <summary>
		/// Arguments:
		/// string name
		/// </summary>
