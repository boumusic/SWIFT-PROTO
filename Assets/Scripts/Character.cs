...
public class Character : MonoBehaviour
{
    ...
    public Vector3 FinalVelocity => CamRotation * Velocity + wallSlideVector;
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.DrawLine(transform.position + Vector3.up, transform.position + Vector3.up + DesiredVelocity * m.desiredCastLength);
    ...
    {
        hits = Physics.RaycastAll(transform.position + Vector3.up, Forward, m.desiredCastLength);
